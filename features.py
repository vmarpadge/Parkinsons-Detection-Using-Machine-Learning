...
and returns the feature vector for the classifier.
"""
...
# All 26 PRAAT-extractable feature columns (0-based CSV column indices).
# Column 0 = Subject ID, columns 1-26 = acoustic features,
# column 27 = excluded (data leakage), column 28 = label.
...
def extract_features(wav_path: str) -> np.ndarray:
    ...
    Returns:
        numpy array of shape (1, 26) with the acoustic features.
    ...
    # Map PRAAT report numbers to 26 acoustic features (matching CSV columns 1-26).
    ...
    all_features = [
        ...
        float(nums[14]),                              # 24: Fraction of locally unvoiced frames %
